...
struct MultiplicationFunctor<Dense,double,P,Dense,double,P,Dense,double,P,Blaze>
{
    void operator () (Matrix<Dense,double,P> const& A, Matrix<Dense,double,P> const& B, Matrix<Dense,double,P>& C)
    {
        ...
        blaze::CustomMatrix<double, blaze::unaligned, blaze::unpadded, blaze::columnMajor> AA(A.getDataPointer(), A.getNbRows(), A.getNbColumns());
        blaze::CustomMatrix<double, blaze::unaligned, blaze::unpadded, blaze::columnMajor> BB(B.getDataPointer(), B.getNbRows(), B.getNbColumns());
