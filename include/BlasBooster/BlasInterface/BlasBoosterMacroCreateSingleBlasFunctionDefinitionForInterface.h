...
#define BLASBOOSTER_MACRO_CREATE_SINGLE_BLAS_FUNCTION_DEFINITION_FOR_INTERFACE(r, data, elem)\
    BOOST_PP_TUPLE_ELEM(3,0,elem) BlasInterface < BOOST_PP_TUPLE_ELEM(2,0,data), BOOST_PP_TUPLE_ELEM(3,1,elem) >::operator()\
	    (BOOST_PP_SEQ_FOR_EACH_I(\
    		BLASBOOSTER_MACRO_CREATE_BLAS_ARGUMENT_LIST_WITH_NAMES,\
			BOOST_PP_SEQ_SIZE(BOOST_PP_TUPLE_ELEM(3,2,elem)),\
			BOOST_PP_TUPLE_ELEM(3,2,elem)))\
    {\
	    return :: BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2,1,data), BOOST_PP_TUPLE_ELEM(3,1,elem)) (BOOST_PP_SEQ_FOR_EACH_I(\
