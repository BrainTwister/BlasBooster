...
struct cdotc
{
    static std::string name() { return "cdotc"; }
};

struct cdotu
{
    static std::string name() { return "cdotu"; }
};

struct zdotc
{
    static std::string name() { return "zdotc"; }
};

struct zdotu
{
    static std::string name() { return "zdotu"; }
};

struct dcsrmm
{
    static std::string name() { return "dcsrmm"; }
};
